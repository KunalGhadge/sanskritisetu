    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      <div>
        <span style={{ fontSize: '0.68rem', color: '#d97706', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 700 }}>
          Sovereign Preservation Archive
        </span>
      ...
      {activeTab === 'overview' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <div className="app-card" style={{ padding: '16px' }}>
            <h4 style={{ fontSize: '0.95rem', fontWeight: 800, color: '#0f172a', marginBottom: '10px' }}>
              Sovereign Registry Specifications
            </h4>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', fontSize: '0.8rem' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', paddingBottom: '6px', borderBottom: '1px solid #f1f5f9' }}>
                <span style={{ color: '#64748b' }}>UNESCO Inscription:</span>
      ...
      {activeTab === 'timeline' && (
        <div className="app-card" style={{ padding: '16px' }}>
          <h4 style={{ fontSize: '0.95rem', fontWeight: 800, color: '#0f172a', marginBottom: '14px' }}>
            Historical Milestones (1336–2026 CE)
          </h4>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <div className="app-card" style={{ padding: '14px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', fontSize: '0.78rem' }}>
              <div style={{ padding: '8px', background: '#f8fafc', borderRadius: '10px' }}>
                <span style={{ color: '#64748b', display: 'block', fontSize: '0.68rem' }}>Primary Material</span>
                <strong style={{ color: '#0f172a' }}>Granite</strong>
              </div>
              <div style={{ padding: '8px', background: '#f8fafc', borderRadius: '10px' }}>
                <span style={{ color: '#64748b', display: 'block', fontSize: '0.68rem' }}>Architectural Style</span>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {monument.architecturalArchive.features.map((f, i) => (
              <div key={i} className="app-card" style={{ padding: '14px' }}>
                <span style={{ fontSize: '0.68rem', color: '#d97706', fontWeight: 700, textTransform: 'uppercase', display: 'block', marginBottom: '2px' }}>
                  {f.category}
                </span>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <div className="app-card" style={{ padding: '12px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px', fontSize: '0.75rem' }}>
              ...
              <div style={{ padding: '6px 8px', background: '#f8fafc', borderRadius: '8px' }}>Checksum: <strong>#9F8A2D</strong></div>
            </div>
          </div>
        </div>
      )}
      ...
      <button
        ...
        style={{ marginTop: '6px', fontSize: '0.88rem' }}
      >
        <Box size={16} />
